...
from src.day12.assignment1 import process_file, sequence_correct, sequence_potentially_correct, fill_in_character


@pytest.mark.parametrize("sequence, sequence_lengths", [
    ("#.#.###", [1, 1, 3]),
    (".#...#....###.", [1, 1, 3]),
    (".#.###.#.######", [1, 3, 1, 6]),
    ("####.#...#...", [4, 1, 1]),
